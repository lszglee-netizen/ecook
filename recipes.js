...
window.RECIPES = [
  ...
  /* ============================================================
     2. KUNG PAO CHICKEN  (stub — fill in the body before publishing)
     ============================================================ */
  {
    ...
    coverAlt: "Kung pao chicken with dried red chillies and roasted peanuts in a black bowl.",
    metaTitle: "Kung Pao Chicken Recipe — The Original Sichuan Version",
    metaDescription:
      "Authentic Sichuan kung pao chicken — diced, velveted, glossy with the famous sweet-sour-numbing sauce. From a Chinese chef who's cooked it for 30 years.",
    story: "PLACEHOLDER — write 2–3 paragraphs of personal story / cultural context here.",
    whyThisWorks: "PLACEHOLDER — 2–4 sentences explaining the technical secret from a chef's view.",
    ingredients: [
      { group: "Main", items: [
        { qty: "12 oz", item: "boneless chicken thigh", note: "(diced 1/2-inch)" },
        { qty: "1/3 cup", item: "raw peanuts", note: "" },
        { qty: "8", item: "dried red chillies", note: "(seeded if you want it milder)" },
      ...
      { group: "Sauce", items: [
        ...
        { qty: "1 tsp",  item: "cornstarch", note: "" },
        { qty: "3 tbsp", item: "water", note: "" },
      ]},
    ],
    instructions: [
      { text: "Marinate the diced chicken for 15 minutes." },
      { text: "Mix the sauce ingredients in a small bowl." },
      { text: "PLACEHOLDER — fill remaining steps with images." },
    ],
    notes: ["PLACEHOLDER — chef's testing notes go here."],
    faqs: [
      { q: "PLACEHOLDER question?", a: "PLACEHOLDER answer." },
    ],
    relatedRecipes: ["mapo-tofu", "dan-dan-noodles"],
    relatedTechniques: ["velveting"],
    relatedGlossary: ["sichuan-peppercorn", "shaoxing-wine"],
    draft: true,  // ← unpublish until story/whyThisWorks/notes are written
  },
